...
<section class="relative mx-auto">
        ...
        <div class="absolute left-1/2 -translate-x-1/2 top-0 -z-10">
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="1404"
                ...
                <defs>
                    ...
                    <radialGradient id="c" cx="50%" cy="0%" r="80.751%" fx="50%" fy="0%"
 ...
 In tribute to Vizcaino, a bio-natural park in Baja California Sur, Mexico, declared a World Heritage site by UNESCO in 1993.
                        ...
                        <div class="mt-8 w-72 md:max-w-xs max-md:mx-auto space-y-2  ">
                            ...
                            <button
                                class="flex items-center text-sm font-medium text-slate-50 rounded border bg-slate-800/25 w-full px-3 py-2 transition duration-150 ease-in-out hover:opacity-100"
                                :class="tab !== '2' ? 'border-slate-700 opacity-50' : 'border-[#2F8CDF] shadow shadow-[#2F8CDF]'"
                                @click.prevent="tab = '2'">
                                <span>SRM: 6</span>
                            </button>
                            <button
                                class="flex items-center text-sm font-medium text-slate-50 rounded border bg-slate-800/25 w-full px-3 py-2 transition duration-150 ease-in-out hover:opacity-100"
                                :class="tab !== '3' ? 'border-slate-700 opacity-50' : 'border-[#2F8CDF] shadow shadow-[#2F8CDF]'"
                                @click.prevent="tab = '3'">
                                <span>IBU: 52</span>
                            </button>
                            <button
            ...
            <div class="flex flex-col md:flex-row justify-center items-center
                ...
                <div class="w-full md:w-2/3  text-center md:text-left mr-4 py-6">
                    <p class="text-lg text-slate-400 mx-10 text-left">
                        Between mountains, plains, beaches, and rocks, 126 species, as unique as the land on which they walk, are hidden from the world. Their white palms still hide rock squirrels and gray whales. Discover our magic
                    </p>
                </div>
